...
1. Open http://localhost:18889 in your browser
...
1. Open http://localhost:18888/docs in your browser
...
2. **Access frontend**: http://localhost:18889
...
3. **Access frontend**: http://localhost:18889
...
3. **Manually trigger** by accessing API directly:
   ```bash
   curl http://localhost:18888/rules
   ```
